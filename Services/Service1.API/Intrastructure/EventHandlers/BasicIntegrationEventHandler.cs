namespace Service1.API.Intrastructure.EventHandlers
{
    using System;
    ...
    public class BasicIntegrationEventHandler: IIntegrationEventHandler<BasicIntegrationEvent>
    {
        ...
        public async Task Handle(BasicIntegrationEvent @event)
        {
            ...
            logger.LogInformation($"{Environment.NewLine}{Environment.NewLine}SERVICE1:: Basic integration event has been received and a the message with requestId '{@event.Id}' was '{@event.Message}' {Environment.NewLine}");
